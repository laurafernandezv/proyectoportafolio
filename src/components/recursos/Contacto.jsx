      ...
      <section className='contacto'>
        <div className='form-contacto'>
          <form className='form' onSubmit={sendEmail}>
            <input className='input' type="text" placeholder='Nombre' onChange={(e) => setNombre(e.target.value)} value={nombre} />
            <input className='input' type="text" placeholder='Apellido' onChange={(e) => setApellido(e.target.value)} value={apellido} />
            ...
            <input className='inputmensaje' type="text" placeholder='Escriba su mensaje' onChange={(e) => setMensaje(e.target.value)} value={mensaje} />
